...
{
	$query=mysqli_query($link,"update table1 set firstname='$_POST[firstname]',lastname='$_POST[lastname]',accesslevel='$_POST[accesslevel]',address='$_POST[address]',password='$_POST[password]' where id=$id");	
	?>
